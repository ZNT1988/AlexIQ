...
export class AlexCrisisManagement extends EventEmitter  {
  ...
  generateTraumaCrisisResponse(detection) {
    return await this.generateWithOpenAI(`Tu es en sécurité maintenant. Ce que tu ressens es...`, context);
  }
