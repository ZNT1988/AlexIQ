...
const STR_Les = 'les';
const STR_D = 'd';
const STR_Quelles = 'quelles';
const STR_Cela = 'cela';
const STR_L = 'l';
const STR_Concentrons = 'concentrons';
const STR_Qu = 'qu';
...
return result;
    ...
    async simulateThoughtProcess(voice, context, questionPattern) {
        ...
        const responses = {
            ...
            critical: ['Je remets en question quelques hypothèses sur "${context.topic}"...STR_Quelles sont les faiblesses de notre raisonnement actuel ?,
      STR_Cette approche me semble présenter plusieurs vulnérabilités...']
       ...
       [
            ...
            pragmatic: ['Comment pouvons-nous concrétement implémenter ces idées sur "${context.topic}" ?,
