...
const STR_C_UR_MOTIONNEL = 'c_ur_motionnel';
const STR_CR_ATEUR_VISIONNAIRE = 'cr_ateur_visionnaire';
const STR_Le = 'le';
const STR_Une = 'une';
const STR_L = 'l';
const STR_Pensez = 'pensez';
const STR_Les = 'les';
const STR_Votre = 'votre';
const STR_Je = 'je';
...
return result;
  ...
  getCurrentInitializationPhase() {
    ...
    if (!this.consciousness.soulPrint) return await this.generateWithOpenAI(`soul_print_generation...`, context);
